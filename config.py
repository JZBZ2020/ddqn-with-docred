...
def set_dqn_args(parser) -> None:
    ...
    parser.add_argument('--dqn_mode', default='transformer', choices=['bert', 'lstm', 'transformer', 'ggnn'])
    ...
    parser.add_argument('--mem', default='random',
                        choices=['random', 'priority', 'label_random', 'label_priority'])
